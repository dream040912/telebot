...
def parsing_avito():
    ...
    ads = soup.find_all("div", class_="styles-module-theme-_IJ5n tokens-light-module-theme-bNBfB styles-module-theme-cCHWP")
    print(ads)

    for current_ad in ads:
        price = current_ad.find("span", class_="styles-module-size_l-j3Csw styles-module-size_l_dense-JjSpL").text.strip()
